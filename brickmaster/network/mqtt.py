...
def ha_discovery_activescript(short_name, system_id, device_info, topic_prefix, ha_base):
    ...
    discovery_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_activescript",
...
def ha_discovery_connectivity(short_name, system_id, device_info, topic_prefix, ha_base):
    ...
    discovery_dict = {
        ...
        'default_entity_id': system_id + "_connectivity",
...
def ha_discovery_display_lcd(short_name, system_id, device_info, topic_prefix, ha_base, sensor):
    ...
    text_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_" + sensor.id + "_text",
...
def ha_discovery_display_seg(short_name, system_id, device_info, topic_prefix, ha_base, display):
    ...
    if display.writable:
        ...
        text_dict = {
            ...
            'device': device_info,
            'default_entity_id': system_id + "_" + display.id + "_text",
...
def ha_discovery_meminfo(short_name, system_id, device_info, topic_prefix, ha_base, mode):
    ...
    memfreepct_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_memfreepct",
    ...
    memusedpct_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_memusedpct",
        'state_topic': topic_prefix + short_name + '/meminfo',
        'unit_of_measurement': '%',
    ...
    memfreebytes_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_memfree",
        'state_topic': topic_prefix + short_name + '/meminfo',
...
def ha_discovery_sensor_HTU31D(short_name, system_id, device_info, topic_prefix, ha_base, sensor):
    ...
    temp_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_" + sensor.id + "_temperature",
    ...
    humidity_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_" + sensor.id + "_humidity",
        'state_topic': topic_prefix + short_name + '/sensors/' + sensor.id + '/status',
...
def ha_discovery_control(short_name, system_id, device_info, topic_prefix, ha_base, control):
    ...
    discovery_dict = {
        ...
        'device': device_info,
        'default_entity_id': system_id + "_" + control.id,
...
def ha_discovery_script(short_name, system_id, device_info, topic_prefix, ha_base,
    ...
    script_selector = {
        ...
        'message': {
            ...
            'device': device_info,
            'default_entity_id': system_id + "_script_select",
